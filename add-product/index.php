 ...
 <span id="missingValueAlert">Please, submit required data</span>
  ...
  <span>
   ...
   <span>
    ...
    <span>
      <input type="text" id="size" class="form_field visible_field type_field" name="size" placeholder="E.G. 500">
    </span>
</div>
   ...
   <span class="type_description">
    ...
    <span
    ><input type="text" id="weight" class="form_field visible_field type_field" name="weight" placeholder="E.G. 2">
  </span>
    </div>
    ...
    <span>
      <input type="text" id="height" class="form_field visible_field type_field" name="height" placeholder="E.G. 45">
    </span>
    </div>
    ...
    <span>
      <input type="text" id="width" class="form_field visible_field type_field" name="width" placeholder="E.G. 24">
    </span>
    </div>
    ...
    <div class="field_container">
        ...
        <span>
          <input type="text" id="length" class="form_field visible_field type_field" name="length" placeholder="E.G. 15">
        </span>
        </div>
